...
recommend_package_dict = {'onnxruntime': '==1.14.1',
...
=============================
'''
default_onnx_model_path = './models_zoo/yolo_v5_x/yolov5x6.onnx'
default_warm_up_image_path = './images/warm_up_image.jpg'
default_classes_txt_path = './classes/classes.txt'
default_confidence_threshold = 0.5
default_iou_threshold = 0.4

default_detect_source_path = './images/warm_up_image.jpg'
...
def parse():
    ...
    parser.add_argument('-show', '--show', action='store_true' if default_show else 'store_false', help='Show result.')
...
def detect_image(image_path=None, bgr_image=None, output_folder_path=None, show=True):
    ...
    # predict
    results = detect_onnx.detect(image=image)
    print(results)
